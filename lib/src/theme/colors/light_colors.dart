...
class LightColors {
  ...
  static const Color lightGreen = Color(0xFF95E08E);
  static const Color lightBlueIsh = Color(0xFF33BBB5);
  static const Color darkGreen = Color(0xFF00AA12);
  static const Color backgroundColor = Color(0xFFEFEEF5);
